...
def main():
    st.title('E-Commerce Product Text Classification')
    st.write("## Text Classification Model Evaluation")
    ...
    # Train your model (assuming 'classifier' is your trained model)
    classifier.fit(X_train_tfidf, y_train)

    # Predict on the test set
    y_pred = classifier.predict(X_test_tfidf)
    
    # Call the classification_report function with true labels (y_test) and predicted labels (y_pred)
    report = classification_report(y_test, y_pred)
    accuracy = accuracy_score(y_test, y_pred)

    # Now you can display the classification report in your Streamlit app
    ...
    st.image(wordcloud_positive.to_array(), caption='Word Cloud for Out of Stock Products')
    st.image(wordcloud_negative.to_array(), caption='Word Cloud for In Stock Products')
